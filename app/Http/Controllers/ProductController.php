   ...
   public function store(Request $request)
    {
        ...
        $rules = [
            ...
            // 'product_intro_image' => 'nullable|mimes:jpg,jpeg,png,mp4,mov|dimensions:min_width=1080,min_height=600,max_width=1080,max_height=600',
        ...
        $msg = [
            ...
            'attachments' => 'Attachments must be pdf file.',
