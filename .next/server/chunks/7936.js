...
const VerifyOtp = ({ csrfToken , onSwap , pillButtons , phoneNumber ="" , userID ="" , titleMsg , removeClose , isSignIN =false , isOTP =false , loginFromOtp =false , reLoadSess =false , setVerifiedUser , type ="" , formData , ...props })=>{
    console.log("Sesion reLoadSess", reLoadSess);
    ...
    const { 0: otpInput , 1: setOtpInput  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(isOTP);
        ...
        if (form.form.checkValidity() === false) {
            ...
            if (captchVal) {
                ...
                if (otp.length > 0) {
                    ...
                    let phonePost = phoneNumber !== "undefined" && ((ref = phoneNumber === null || phoneNumber === void 0 ? void 0 : phoneNumber.trim()) === null || ref === void 0 ? void 0 : ref.length) == 10 ? phoneNumber : phone;
                    let otpPost = otp;
                    if (session) {
                        if (reLoadSess) {
                            let userIDlogin = session.user.id;
                            let addJson = await (0,next_auth_react__WEBPACK_IMPORTED_MODULE_6__.signIn)("phone-login", {
                                "phone": phonePost,
                                "captcha": captchVal,
                                "otp": otpPost,
                                "user": userIDlogin,
                            ...
                            if (addJson.status != "undefined" && addJson.status == 200) {
                                ...
                                setShowAlert(true) // alert message will show
                                ;
                                setError((addJson === null || addJson === void 0 ? void 0 : addJson.msg) || "Invalid OTP.");
                            }
                        }
                    } else if (loginFromOtp) {
                        let addJson = await (0,next_auth_react__WEBPACK_IMPORTED_MODULE_6__.signIn)("login-via-otp", {
                            redirect: false,
                            "phone": phonePost,
                            "name": formData.name,
                        ...
                        if (addJson.status != "undefined" && addJson.status == 200) {
                            ...
                            ;
                            setError("OTP Verified.");
                            //vs- set the status of free listing user verified status                                 
                            setVerifiedUser(true);
                            props.onHide();
                            if (!isSignIN) {
                            //props.onHide()
                    ...
                    let phonePost = phone;
                    phoneNumber = phone;
                    if (phonePost.charAt(0) === "0") {
                        setAlertType("danger");
                        setError("The first digit cannot be 0.");
                        setShowAlert(true) // alert message will show
                        ;
                    } else {
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_bootstrap_Modal__WEBPACK_IMPORTED_MODULE_2___default()), {
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((react_bootstrap_Modal__WEBPACK_IMPORTED_MODULE_2___default().Body), {
            className: "px-0 py-2 py-sm-2 pb-md-0 pb-4 pb-sm-2",
            children: [
                ...
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    ...
                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        className: "col-md-12 px-3 pt-2 pb-0 px-sm-5 pb-sm-4 pt-md-4",
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                className: "blog-title text-center",
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("h4", {
                                        className: "mt-3 mt-sm-0 mb-2",
                                        children: [
                                            " ",
                                            titleMsg
                                        ]
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
                                        className: "mb-2",
                                        children: [
                                            isOTP ? "Enter the OTP you received on your Mobile number" : "Enter the number to receive OTP on your Mobile number",
                                            " "
                                        ]
                                    })
                                ]
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((react_bootstrap_Form__WEBPACK_IMPORTED_MODULE_3___default()), {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_bootstrap_Form__WEBPACK_IMPORTED_MODULE_3___default().Group), {
                                        ...
                                        className: "mb-2 mb-md-3 text-center md-3",
                                        children: otpPhone !== "undefined" && otpPhone !== null && otpPhone.length == 10 || (phoneNumber === null || phoneNumber === void 0 ? void 0 : phoneNumber.length) == 10 ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((react_bootstrap_Form__WEBPACK_IMPORTED_MODULE_3___default().Label), {
                                            className: "",
                                            children: [
                                                "Phone +91- ",
                                                otpPhone.substr(0, 6) + "****"
                                            ...
                                            pattern: "[0-9]{10}",
                                            format: "##########",
                                            className: "ddd-" + otpPhone,
                                            required: true,
                                            title: "Please enter 10 digits phone number"
                                        })
                                    }),
                                    otpInput && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((react_bootstrap_Form__WEBPACK_IMPORTED_MODULE_3___default().Group), {
                                    ...
                                    resendBtn && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        className: "mt-3 text-center mb-4 dontaccount fs-sm",
                                        children: [
                                            "Didn\u2019t receive code? ",
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("a", {
                                                href: "#",
