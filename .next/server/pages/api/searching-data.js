...
async function handler(req, res) {
    try {
        ...
        if (req.method == "POST") {
            ...
            // Added by kartik pareek on 01-06-2023 for resolve https://www.dialmenow.in/Bikaner/Radio-Stations/contact-details these kind of issues
            if (searchData.length > 0 && (searchData[searchData.length - 1] === "contact-details" || searchData[searchData.length - 1] === "edit-list")) {
                searchData.pop(); // Remove the last element
            }
            ...
            if (searchData.length >= 4) {
                ...
                if (cityData) {
                    ...
                    //searchData[3]   // Removed by kartik pareek on 21-06-2023
                ...
                if (cityData) {
                    ...
                    if ((category === null || category === void 0 ? void 0 : category.length) > 0) {
                        ...
                        if (listings.length > 0) {
                            ...
                            //if category record not found in city  than we get state wise record of this city
...
var __webpack_exports__ = __webpack_require__.X(0, [8365,2212], () => (__webpack_exec__(5662)));
