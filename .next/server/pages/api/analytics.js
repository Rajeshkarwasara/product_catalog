...
async function handler(req, res) {
    try {
        ...
        if (req.method == "GET" && (originPath == "localhost:3000" || originPath == "app.dialmenow.in" || originPath == "dialmenow.in" || originPath == "www.dialmenow.in" || originPath == "m.dialmenow.in") && req.headers["referer"] != undefined) {
...
var __webpack_exports__ = __webpack_require__.X(0, [2212], () => (__webpack_exec__(1352)));
