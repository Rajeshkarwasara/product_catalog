...
async function getServerSideProps(ct) {
    ...
    let srRes = await fetch(`${process.env.BASE_URL}/api/protect/check-mail`, {
        method: "POST",
        body: JSON.stringify({
            "code": reset_code,
            "is_verify": true
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,1664,1486,9807,1636,261,7936,7840,4178,554,3930,7229,9340], () => (__webpack_exec__(5861)));
