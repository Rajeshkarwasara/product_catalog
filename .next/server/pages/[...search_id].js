...
, {
    loadableGenerated: {
        modules: [
            "[...search_id].js -> " + "../components/searching/BusinessDetails"
        ]
    },
    ssr: true
});
...
, {
    loadableGenerated: {
        modules: [
            "[...search_id].js -> " + "../components/searching/BusinessListings"
        ]
    },
    ssr: true
});
...
, {
    loadableGenerated: {
        modules: [
            "[...search_id].js -> " + "../components/searching/CategoryLisitng"
        ]
    },
    ssr: true
});
const NoSearchFound = (0,next_dynamic__WEBPACK_IMPORTED_MODULE_2__["default"])(null, {
    loadableGenerated: {
        modules: [
            "[...search_id].js -> " + "../components/searching/NoSearchFound"
        ]
    },
    ssr: false
});
const EditListing = (0,next_dynamic__WEBPACK_IMPORTED_MODULE_2__["default"])(null, {
    loadableGenerated: {
        modules: [
            "[...search_id].js -> " + "../components/searching/BusinessEditListing"
        ]
    },
    ssr: false
});
const SearchHeader = (0,next_dynamic__WEBPACK_IMPORTED_MODULE_2__["default"])(null, {
    loadableGenerated: {
        modules: [
            "[...search_id].js -> " + "../components/searching/head/SearchDiv"
        ]
    },
    ssr: false
});
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,1664,1486,9807,1636,8184,8176], () => (__webpack_exec__(3553)));
