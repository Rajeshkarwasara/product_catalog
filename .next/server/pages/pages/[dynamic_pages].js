                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        children: [
                            ...
                            pageContent.page_slug == "aboutus" || pageContent.page_slug == "rajasthan-business-directory" || pageContent.page_slug == "rajasthan-industries-directory" || pageContent.page_slug == "jaipur-city-map" || pageContent.page_slug == "rajasthan-exporters-directory" ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                                children: [
...
async function getServerSideProps(ct) {
    ...
    //filter the our publication data array
    if (ourPublications.length > 0 && (ct.query.dynamic_pages == "rajasthan-business-directory" || ct.query.dynamic_pages == "rajasthan-industries-directory" || ct.query.dynamic_pages == "jaipur-city-map" || ct.query.dynamic_pages == "rajasthan-exporters-directory")) {
        let createRedirectURL = `${process.env.BASE_URL}/pages/${ct.query.dynamic_pages}`;
        //let createRedirectURL = `https://app.dialmenow.in/pages/${ct.query.dynamic_pages}`;
        ourPublications = ourPublications.filter((obj)=>obj.redirect_link !== createRedirectURL
        );
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,1664,1486,9807,1636,261,7936,7840,4178,554,3930,7229,9340,8184,329,8556,8825,6492,127,4299,9864,8006], () => (__webpack_exec__(3331)));
