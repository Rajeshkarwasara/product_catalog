...
<div class="product_slider">
    <div class="container">
        ...
        <div class="product_inner">
            <div class="row">
                @foreach ($products as $product)
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12" id="product-container">
                        <div class="product_card">
                            <a href="{{ route('productdetails', $product->id) }}">
                                <div class="product_img">
                                    <img src="{{asset('uploads/product/product_image/' . $product->product_image)}}" alt="">
                                ...
                                <div class="product_con">
                                    ...
                                    <h3>{{$product->name}}</h3>
                                    <h5>{{$product->code}}</h5>
                                    @if(Auth::guard('local')->check() && Auth::guard('local')->user()->user_type == "normal")
...
<div class="ads_card">
    <div class="container">
        <div class="ads_inner">
            <img src="{{asset('stc_css/images/google_ads.png')}}" alt="">
        </div>
    </div>
</div>
