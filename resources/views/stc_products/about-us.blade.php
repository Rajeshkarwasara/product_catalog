            ...
            @foreach ($aboutus as $about)
                ...
                <div class="col-md-6">
                    <div class="about_hero_img">
                        <img src="{{asset('uploads/page/' . $about->image)}}" alt="" />
                    </div>
                </div>
            @endforeach
        </div>
...
<div class="about_counter">
    <div class="container">
        <div class="row">
            ...
            <div class="four col-md-3 col-sm-6 col-6">
                <div class="counter-box"> <span class="counter">12</span>
                    <p>سنوات من الخبرة</p>
                </div>
            </div>
            <div class="four col-md-3 col-sm-6 col-6">
                <div class="counter-box"> <span class="counter">800</span>
                    <p>نوع المنتج</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="summery_card">
                    ...
                    <p>يُعد نص Lorem Ipsum ببساطة نصًا شكليًا (بمعنى غير حقيقي) يستخدم في صناعة الطباعة والتنضيد. وقد ظل
                        ...
                        مجموعة من الحروف وخلطها لصنع كتاب عينات الحروف.</p>
