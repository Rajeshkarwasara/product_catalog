        ...
        <div class="card">
            <div class="row row-bordered g-0">
                ...
                <div class="col-md-4">
                        ...
                        <div class="text-center">
                            <div class="dropdown">
                                <button class="btn btn-sm btn-outline-primary dropdown-toggle" type="button"
                                    ...
                                    aria-expanded="false">
                                    @php
                                    // Get the highest key from the $growthRates array
                                    $highestKey = max(array_keys($growthRates));
                                    @endphp
                                    {{ $highestKey }} <!-- Display the highest key in the button initially -->
                                </button>
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="growthReportId">
                                    ...
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="fetchDataAndRendergrowthChart('#growthCharts', 'growthcharts', '{{ $key }}' , this)">{{ $key }}</a>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                    ...
                    @endphp
                    @foreach($growthRates as $key => $data)
                    @if($highestKey === $key)
                    <div class="text-center fw-medium pt-3 mb-2" id="company_growth">{{ $data }}% Company Growth</div>
                    @endif
                    @endforeach
                    <div class="d-flex flex-wrap px-2 p-4 gap-3" id="current">
                        @php
                        $lastTwoSalesData = array_slice($salesData, -2, 2, true);
                        ...
                        <div class="d-flex">
                            <div class="me-2">
                                <span class="badge bg-label-primary p-2"><i
                                        class="bx bx-box text-primary"></i></span>
                            </div>
            ...
            <div class="col-lg-6 col-md-4 col-sm-6 mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-2">23</h4>
                        <!-- <small class="text-success fw-semibold"><i class='bx bx-up-arrow-alt'></i> +28.14%</small> -->
                    </div>
                </div>
            </div>
