                    ...
                    <div class="order-id d-flex align-items-start justify-content-between">
                        <div class="">
                            <div class="d-flex align-items-center">
                                <h6 class="mb-0">Inquiry Id:{{ $order->id }}</h6>
                            ...
                            @endphp
                            <p class="mb-0">Inquiry on {{ $formattedDate }}</p>
                        </div>

                        <div class="d-flex">
                            <!-- <div class="invoice_down" style="margin-right:16px;margin-top: 3px;">
                                <a href="{{ url('inquiry/downloadinvoice/' . base64_encode($order->id)) }}"
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-right">
                                            <div class="prod-img">
                                                ...
                                                <img src="{{ url('/uploads/product/inquiry.inquiry_status/' . $product_image) }}" alt="">
                        ...
                        $('#saveChangesBtn').on('click', function() {
                            $("#addEditForm1").validate({
                                ...
                                submitHandler: function(form) {
                                    ...
                                    var urlp = "{{ route('inquiry.inquiry_status') }}";
