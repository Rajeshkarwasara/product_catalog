...
<div class="app-ecommerce">
    ...
    <form id="addEditForm" method="POST" enctype="multipart/form-data">
        <input type="hidden" class="form-control" id="id" placeholder="" name='id' value="{{ isset($product_detail) ? $product_detail->id :'0'}}">
        @csrf
        <div class="row">
            <!-- First column-->
            <div class="col-12 col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <label class="form-label" for="ecommerce-product-name">Product Name<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="ecommerce-product-name" placeholder="Product Name" name="name" aria-label="Product name" value="{{ isset($product_detail) ? $product_detail->name :''}}">
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                            </div>
                            <div class="col-sm-6">
                                <label class="form-label" for="code">Product Code<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="code" placeholder=" Product Code" name="code" aria-label=" Product URL" value="{{ isset($product_detail) ? $product_detail->code :''}}">
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                            </div>
                            <div class="col-sm-6 mt-2">
                                ...
                                <select class="form-control form-select" id="brands" name="brands">
                                    ...
                                    <option value="{{$brands_data->id}}" {{ isset($product_detail) && $product_detail->brands == $brands_data->id? 'selected' : '' }}>{{$brands_data->name}}</option>
                                    @endforeach
                                </select>
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                            </div>
                            <div class="col-sm-6 mt-2">
                                ...
                                <select class="form-control form-select" id="category" name="category">
                                    ...
                                    <option value="{{$category_data->id}}" {{ isset($product_detail) && ($product_detail->category_id == $category_data->id)? 'selected' : '' }}>{{$category_data->name}}</option>
                                    @endforeach
                                </select>
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                            </div>
                            ...
                            <!-- <div class="col-sm-6 mt-2">
                                <label class="form-label" for="subcategory">Subcategories<span class="text-danger">*</span></label>
                                <select class="form-control form-select" id="subcategory" name="subcategory">
                                    <option value="" selected disabled>Select Subcategory</option>
                                    @foreach($subcategory as $subcategory_data)
                                    <option value="{{$subcategory_data->id}}" {{ isset($product_detail) && ($product_detail->subcategory_id == $subcategory_data->id)? 'selected' : '' }}>{{$subcategory_data->name}}</option>
                                    @endforeach
                                </select>
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                            </div> -->
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="origin" placeholder="ORIGIN" name="origin" aria-label="Origin " value="{{ isset($product_detail) ? $product_detail->origin :''}}">
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                            </div>
                            <div class="col-sm-6">
                                <label class="form-label" for="measurement">MEASUREMENTS<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="measurement" placeholder="Measurement" name="measurement" aria-label="Measurement " value="{{ isset($product_detail) ? $product_detail->measurements :''}}">
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                            </div>
                            <div class="col-sm-6">
                                <label class="form-label" for="warranty">WARRANTY (number of months)<span class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="warranty" placeholder="WARRANTY (number of months)" name="warranty" aria-label="Warranty " value="{{ isset($product_detail) ? $product_detail->warranty :''}}">
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                            </div>
                            <div class="col-sm-6 mt-2">
                                <label class="form-label" for="ecommerce-product-name">Product Image<span class="text-danger">*</span></label>
                                <input type="file" class="form-control" id="product_intro_image" placeholder="Product Image" name="product_intro_image" aria-label="Image/Vedio">
                                ...
                                @if(isset($product_detail->product_image))
                                  @if(str_contains($product_detail->product_image, '.mp4') || str_contains($product_detail->product_image, '.webm'))
                                    <video width="100" height="100" controls>
                                      <source src="{{ asset('uploads/product/product_image/' . $product_detail->product_image) }}" type="video/mp4">
                                      Your browser does not support the video tag.
                                    </video>
                                  @else
                                    <img src="{{ asset('uploads/product/product_image/' . $product_detail->product_image) }}" alt="Product Image">
                                  @endif
                                @endif
                              </div>
                            @endunless
                          ...
                          @endif
                            <div class="col-sm-12 mt-2">
                                ...
                                <textarea class="form-control" id="summary" placeholder="Summary" name="summary" aria-label="summary">{{ isset($product_detail) ? $product_detail->summary :''}}</textarea>
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                            </div>
                    ...
                    <div class="row mb-3">
                        {{-- <div class="col-sm-6">
                            <label class="form-label" for="ecommerce-product-sku">SKU<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ecommerce-product-sku" placeholder="SKU" name="sku" aria-label="Product SKU" value="{{ isset($product_detail) ? $product_detail->sku :''}}">
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                        </div> --}}
                        <div class="col-sm-6">
                            <label class="form-label" for="ecommerce-product-attachments">Attachments<span class="text-danger">*</span></label>
                            <input type="file" class="form-control" id="attachments" placeholder="Attachements" name="attachments" aria-label="Product Attachments" >
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                            @if(isset($product_detail))
                            @unless(isset($product_detail->id))
                                <div class="col-sm-6 mt-2 image-border-shap d-none mb-3" id="image-border-shap">
                                    @if(isset($product_detail->attachments))
                                        @if(str_contains($product_detail->attachments, '.pdf'))
                                            <a href="{{ asset('uploads/product/attachments/' . $product_detail->attachments) }}" target="_blank">
                                                <i class="menu-icon tf-icons bx bxs-file-pdf" style="color: red; font-size: 80px;"></i>
                                            </a>
                                        @elseif(str_contains($product_detail->attachments, ['.jpg', '.jpeg', '.png', '.gif']))
                                            <img src="{{ asset('uploads/product/attachments/' . $product_detail->attachments) }}" alt="Attachements">
                                        @else
                                            <a href="{{ asset('uploads/product/attachments/' . $product_detail->attachments) }}" target="_blank">
                                                Download Document
                                            </a>
                                ...
                                <div class="col-sm-6 mt-2 image-border-shap mb-3" id="image-border-shap">
                                    @if(isset($product_detail->attachments))
                                        ...
                                        @elseif(preg_match('/\.(jpg|jpeg|png|gif)$/i', $product_detail->attachments))
                                            <img src="{{ asset('uploads/product/attachments/' . $product_detail->attachments) }}" alt="Attachments">
                                        @else
                                            <a href="{{ asset('uploads/product/attachments/' . $product_detail->attachments) }}" target="_blank">
                                                Download Document
                                            </a>
                        ...
                        <div class="col-sm-6">
                            <label class="form-label" for="ecommerce-stock-quantity">Stock Quantity<span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="ecommerce-stock-quantity" placeholder="Stock Quantity" name="stock_quantity" aria-label="Stock Quantity" value="{{ isset($product_detail) ? $product_detail->stock_quantity :''}}">
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                        </div>

<div class="col-sm-6 mt-2">
                                <label class="form-label" for="bestseller">Best Seller<span class="text-danger">*</span></label>
 ...
 <div class="col-sm-6 mt-2">
                                <label class="form-label" for="newproduct">New Products<span class="text-danger">*</span></label>
                    ...
                    <div class="col-sm-6 mt-2">
                                <label class="form-label" for="newproduct">Most Populer<span class="text-danger">*</span></label>
                    ...
                    <div class="d-flex justify-content-between align-items-center border-top border-bottom pb-3 pt-3 mb-3">
                    ...
                    <div class="form-group" id='editor'>
                        <label class="form-label editor">Full Description <span class="text-muted"></span><span class="text-danger">*</span></label>
                        <textarea id="description" placeholder="Full Description" class="form-control" name="description" value="{{ isset($product_detail) ? $product_detail->full_description :''}}">{{ isset($product_detail) ? $product_detail->full_description :''}}</textarea>
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" placeholder="M.R.P " id="normal_price" name="normal_price" aria-label="M.R.P" value="{{ isset($product_detail) ? $product_detail->normal_price :''}}">
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="mrp">Loyal User price</label>
                        <input type="number" class="form-control" placeholder="M.R.P " id="loyal_price" name="loyal_price" aria-label="M.R.P" value="{{ isset($product_detail) ? $product_detail->loyal_price :''}}">
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="mrp">WholeSaler price</label>
                        <input type="number" class="form-control" placeholder="M.R.P " id="wolesales_price" name="wolesales_price" aria-label="M.R.P" value="{{ isset($product_detail) ? $product_detail->wholesaler_price :''}}">
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <!-- Meta Title -->
                        <div class="mb-3 col">
                            <label class="form-label mb-1" for="ecommerce-meta-title">Meta Title<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ecommerce-meta-title" placeholder="Meta Title" name="meta_title" aria-label="Meta Title" value="{{ isset($product_detail) ? $product_detail->meta_title :''}}">
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                        </div>
                        <!-- /Meta Title -->
                        <!-- Meta Keyword -->
                        <div class="mb-3 col">
                            <label class="form-label mb-1" for="ecommerce-meta-keyword">Meta Keyword<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ecommerce-meta-keyword" placeholder="Meta Keyword" name="meta_keyword" aria-label="Meta Keyword" value="{{ isset($product_detail) ? $product_detail->meta_keyword :''}}">
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                        </div>
                        <!-- /Meta Keyword -->
                        <!-- Meta Description -->
                        <div class="mb-3 col">
                            <label class="form-label mb-1" for="ecommerce-meta-description">Meta Description<span class="text-danger">*</span></label>
                            <textarea type="text" class="form-control" id="ecommerce-meta-description" placeholder="Meta Description" name="meta_description" aria-label="Meta Description">{{ isset($product_detail) ? $product_detail->meta_description :''}}</textarea>
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                        </div>
                        <!-- /Meta Description -->
                    </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.subcategories) {
                        // Loop through subcategories and append each to the subcategory dropdown
