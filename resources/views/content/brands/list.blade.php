...
<div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3 fv-plugins-icon-container">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Brands Name" name="name" aria-label="Name">
    ...
    <div class="offcanvas offcanvas-end w-30" id="viewModal" aria-labelledby="offcanvasViewLabel" aria-modal="true" role="dialog">
        <div class="offcanvas-header">
            <h5 id="offcanvasViewLabel" class="offcanvas-title">View Brands</h5>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body mx-0 flex-grow-0">
            <div class="row">
                <div class="col-sm-12">
                    <div class="mb-3 fv-plugins-icon-container">
                        <label class="form-label" for="view_brands"><b>Brand Name:</b></label>
                        <div class="view_brands"></div>
                    </div>
                </div>

                <div class="col-sm-12">
                    <div class="mb-3 fv-plugins-icon-container">
                        <label class="form-label" for="view_image"><b>Brand Logo:</b></label>
                ...
                <div class="col-sm-12">
                    <div class="mb-3 fv-plugins-icon-container">
                        <label class="form-label" for="view_date"><b>Created Date:</b></label>
        ...
        $(document).ready(function() {
            ...
            var table = $('#listing_table').DataTable({
                ...
                columnDefs: [{
                    ...
                    {
                        targets: 2, // Targeting the 'image' column (index 2)
                        data: 'image',
                        name: 'image',
                        orderable: false,
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (response.code == 200) {
                        ...
                        $("#addEditModal").find("#existing-image").attr("src", 'uploads/Brands/' + item.image);
                        var imageUrl = item.image ? 'uploads/Brands/' + item.image : 'uploads/default_image/default.png';
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (response.code == 200) {
                        ...
                        //set edit id
                        console.log(item)
                        let base_url = 'uploads/Brands'
                        $("#viewModal .view_brands").text(item.name);
